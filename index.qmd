  ...
  <div class="splide__track">
		<ul class="splide__list">
			<li class="splide__slide">
                ...
                <div class="hsma_caption" data-splide-interval="10000">
            ...
            <li class="splide__slide" data-splide-interval="10000">
				<img src="resources/lecture_examples/des_playground.png" alt="">
                <div class="hsma_caption">
            ...
            <li class="splide__slide" data-splide-interval="12000">
                ...
                <div class="hsma_caption">
                Aligning with the NHS's focus on reproducible analytical pipelines, HSMA's focus on Python and dedicated content on reproducible outputs with Quarto and other tools can help individuals to get rid of repetitive, manual process; reduce mistakes; and free up time for doing more advanced work.
                </div>
			</li>
            <li class="splide__slide" data-splide-interval="10000">
				<img src="resources/lecture_examples/reinforcement_learning.png" alt="">
                <div class="hsma_caption">
