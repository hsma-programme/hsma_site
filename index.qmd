...
We are also putting together a new series of standalone workshops aimed at senior leaders, called HSMA-λ (lambda), which we hope to run in **Autumn 2026**. Click [here](lambda.qmd) to find out more, and let us know you're interested by filling in [this form](https://forms.cloud.microsoft/e/spFr8qr2pP).
