...
listing:
    - id: books
      contents: "hsma_content/books/book_details/*.qmd"
      sort: "date"
      type: grid
      grid-columns: 2
      categories: false
...
Prefer to follow along with the original session recordings, slides and exercises? Head to the [modules](modules.qmd) page instead.
