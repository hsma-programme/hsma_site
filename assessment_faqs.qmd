...
It's important to remember that, for you to receive the digital certificate confirming completion of the HSMA programme, your project does not have to be
...
We're not looking for perfect code or a huge codebase - just enough to evidence that you are able to write code and make use of one or more of the techniques/topics taught on the course.
...
Providing the code as a GitHub repository is the preferred alternative for several reasons.
...
We don't need to be able to run the code to provide accreditation - though it's great if we, and the wider community of people who may wish to reuse your code, can. To this end, consider whether you might want to provide a dummy dataset intead, which doesn't necessarily have to replicate the patterns seen in your real data as long as the structure/data types are the same as the real data.
...
While this is not ideal as it means we will not be able to see the commit history, it will
...
Where this is not possible to provide, a written statement signed by all HSMAs involved in the project can be provided, detailing the areas of contribution to the project from each HSMA.

Please contact programme staff if you have further questions about this.
...
It is fine to submit a project where you have collaborated with non-HSMAs - but please make sure authorship is clear, either via GitHub commit history or through a statement of contribution (see the previous Question/Answer).
...
It's important to remember that the certificate issues is a mark of your own personal completion of the HSMA programme - **we are not certifying your project**, but instead using your project to provide evidence that you can apply the skills taught on the HSMA programme.
...
If you are in the situation, please reach out to Dan and Sammi via Slack in a direct message, and we will see if we can find a different way for you to evidence the skills you have picked up from the programme and receive your certificate.


## Option 2: Undertake the HSMA 6 Assessment

:::{.callout-tip collapse="true"}
### The HSMA 6 assessment date has passed. There is currently no assessment planned. If you are looking to be certified, please see the details above about the project certification route.
