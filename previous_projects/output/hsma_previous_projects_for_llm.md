...
- Abstract and description text is reproduced verbatim from the source pages, including any British spellings and Quarto shortcodes such as `{{< video ... >}}`. Only the metadata has been reformatted.
...
## H5-5002 — Using Natural Language Processing to detect drug related content within free text 

- **Project ID:** H5-5002
- **Cohort:** HSMA 5
- **Authors:** Lauren Szarvas; Holly Dale; Tom Haddock
- **Organisations:** Not recorded
- **Techniques:** Natural Language Processing (NLP), Named Entity Recognition
- **Application areas:** Police
- **Public code repository:** No
- **Source file:** previous_projects/hsma_5/h5_5002_nlp_drug_content/index.qmd
- **Links:**
...
## H6-6023 — Predicting Gestational Diabetes and other maternity-related conditions using machine learning

- **Project ID:** H6-6023
- **Cohort:** HSMA 6
- **Authors:** Rochelle Francis-Reid (Epsom and St Helier University Hospitals NHS Trust)
- **Organisations:** Epsom and St Helier University Hospitals NHS Trust
- **Techniques:** Machine Learning, Streamlit
- **Application areas:** Diabetes, Maternity, Women's Health, NHS 10-year plan shifts: Sickness to Prevention, NHS 10-year big bet: AI to drive productivity
- **Status:** Active
- **Public code repository:** No
- **Source file:** previous_projects/hsma_6/H6_6023_predicting_gestational_diabetes_using_ML/index.qmd
- **Links:**
    - Video: https://youtu.be/zeYG0EJ83bA?feature=shared
