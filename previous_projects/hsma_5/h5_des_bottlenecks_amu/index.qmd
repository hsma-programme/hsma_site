...
pub-info:
  abstract: |
    In this project, a simulated version of the acute medical pathway in a trust was created, along with an interactive tool allowing parameters such as the staffing levels to be changed to explore the optimum way to allow for risk-free testing of staffing and resource changes.
  links:
  - name: Video
